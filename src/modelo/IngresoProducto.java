...
public class IngresoProducto {
    ...
    public IngresoProducto(int IDINGRESOPRODUCTO, String CODIGO, String NOMBRE, String EMPSERV, String PRODUCTO, String COLOR, String TALLA, int CANTIDAD, int CANTIDADDEFECTUOSA, int ESTADO) {
